...
def repository_info_columns(repositories):
    return [
        ...
        case([
                (repositories.c.import_state == RepositoryImportState.IMPORT_DISABLED, 'import-disabled'),
                (repositories.c.import_state == RepositoryImportState.IMPORT_READY, 'import-ready'),
                (repositories.c.import_state == RepositoryImportState.IMPORT_SMALL_READY, 'import-ready'),
                (repositories.c.import_state == RepositoryImportState.IMPORT_PENDING, 'import-queued'),
                (repositories.c.import_state == RepositoryImportState.IMPORT_FAILED, 'import-failed'),
                (repositories.c.import_state == RepositoryImportState.IMPORT_TIMED_OUT, 'import-timeout'),
                (repositories.c.import_state == RepositoryImportState.CHECK_FOR_UPDATES, 'polling'),
                (repositories.c.import_state == RepositoryImportState.SYNC_FAILED, 'polling-failed'),
                (repositories.c.import_state == RepositoryImportState.UPDATE_READY, 'update-ready'),
                (repositories.c.import_state == RepositoryImportState.UPDATE_PENDING, 'update-queued'),
                (repositories.c.import_state == RepositoryImportState.UPDATE_FAILED, 'update-failed'),
                (repositories.c.import_state == RepositoryImportState.UPDATE_LARGE_READY, 'update-ready'),
                (repositories.c.import_state == RepositoryImportState.UPDATE_TIMED_OUT, 'update-timeout'),
            ]
        ).label('import_state'),
        case(
            [
